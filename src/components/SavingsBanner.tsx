    ...
    <div className="container max-w-6xl mx-auto px-4">
      <div className="rounded-xl border border-border bg-card p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <p className="text-foreground text-sm leading-relaxed">
          ...
          <span className="font-semibold text-primary">$300–800/month</span>, every month, forever — and your data lives on their servers. MEP Claw runs the same workflows for{" "}
          <span className="text-3xl md:text-4xl font-extrabold text-primary">~$20/month</span>{" "}
          on hardware you own.
        </p>
      </div>
    </div>
