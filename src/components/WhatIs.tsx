const WhatIs = () => (
  <section id="what-is" className="py-20 md:py-28 bg-background">
    <div className="container max-w-6xl mx-auto px-4">
      ...
      <p className="text-muted-foreground mb-8 max-w-3xl leading-relaxed text-sm">
        One quiet Mini PC ships to your door pre-loaded for your trade. Plug it in, connect to Wi-Fi, and you own everything outright. <strong className="text-foreground">​</strong>
      </p>
